...
## Assumptions and limitations
* The telemetry playbook only works on AL2, because of [this line](https://github.com/RoDFOPAV49bGd/JJXZbdBayXaTn/blob/44d4321a5f34f7c068fce2731d458c74489a8734/role-docker/tasks/main.yml#L4) of a dependency (it can be fixed easily)
## Problems
